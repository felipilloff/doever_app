...
class $ListsTable extends Lists with TableInfo<$ListsTable, ListRow> {
  ...
  late final GeneratedColumn<int> color = GeneratedColumn<int>(
    ...
    defaultValue: const Constant(0xff426b59),
  );
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  static const VerificationMeta _myDayDateMeta = const VerificationMeta(
    'myDayDate',
  );
  @override
  ...
  static const VerificationMeta _nextOccurrenceIdMeta = const VerificationMeta(
    'nextOccurrenceId',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('my_day_date')) {
      context.handle(
        _myDayDateMeta,
        myDayDate.isAcceptableOrUnknown(data['my_day_date']!, _myDayDateMeta),
      );
    }
    ...
    if (data.containsKey('next_occurrence_id')) {
      context.handle(
        _nextOccurrenceIdMeta,
        nextOccurrenceId.isAcceptableOrUnknown(
          data['next_occurrence_id']!,
          _nextOccurrenceIdMeta,
        ),
      );
    }
...
class $ReminderJobsTable extends ReminderJobs
    with TableInfo<$ReminderJobsTable, ReminderJob> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ReminderJobsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ReminderJob> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  ReminderJob map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReminderJob(
  ...
  @override
  $ReminderJobsTable createAlias(String alias) {
    return $ReminderJobsTable(attachedDatabase, alias);
  }
}

class ReminderJob extends DataClass implements Insertable<ReminderJob> {
  ...
  ReminderJob copyWithCompanion(ReminderJobsCompanion data) {
    return ReminderJob(
  ...
  @override
  String toString() {
    return (StringBuffer('ReminderJob(')
...
class ReminderJobsCompanion extends UpdateCompanion<ReminderJob> {
  ...
  static Insertable<ReminderJob> custom({
...
final class $$TasksTableReferences
  ...
  static MultiTypedResultKey<$StepsTable, List<Step>> _stepsRefsTable(
    ...
    db.steps,
    aliasName: 'tasks__id__steps__task_id',
  );
  ...
  static MultiTypedResultKey<$ReminderJobsTable, List<ReminderJob>>
  _reminderJobsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.reminderJobs,
    aliasName: 'tasks__id__reminder_jobs__task_id',
  );

  $$ReminderJobsTableProcessedTableManager get reminderJobsRefs {
    final manager = $$ReminderJobsTableTableManager(
      $_db,
      $_db.reminderJobs,
    ).filter((f) => f.taskId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_reminderJobsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  ColumnFilters<String> get myDayDate => $composableBuilder(
    column: $table.myDayDate,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get nextOccurrenceId => $composableBuilder(
    column: $table.nextOccurrenceId,
    builder: (column) => ColumnFilters(column),
  );
  ...
  Expression<bool> reminderJobsRefs(
    Expression<bool> Function($$ReminderJobsTableFilterComposer f) f,
  ) {
    final $$ReminderJobsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.reminderJobs,
      getReferencedColumn: (t) => t.taskId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ReminderJobsTableFilterComposer(
            $db: $db,
            $table: $db.reminderJobs,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$TasksTableOrderingComposer
  ...
  ColumnOrderings<String> get myDayDate => $composableBuilder(
    column: $table.myDayDate,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get nextOccurrenceId => $composableBuilder(
    column: $table.nextOccurrenceId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TasksTableAnnotationComposer
  ...
  GeneratedColumn<String> get myDayDate =>
      $composableBuilder(column: $table.myDayDate, builder: (column) => column);
  ...
  GeneratedColumn<String> get nextOccurrenceId => $composableBuilder(
    column: $table.nextOccurrenceId,
    builder: (column) => column,
  );
  ...
  Expression<T> reminderJobsRefs<T extends Object>(
    Expression<T> Function($$ReminderJobsTableAnnotationComposer a) f,
  ) {
    final $$ReminderJobsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.reminderJobs,
      getReferencedColumn: (t) => t.taskId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ReminderJobsTableAnnotationComposer(
            $db: $db,
            $table: $db.reminderJobs,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({listId = false, stepsRefs = false, reminderJobsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (stepsRefs) db.steps,
                    if (reminderJobsRefs) db.reminderJobs,
                  ],
                  addJoins:
                      <
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (stepsRefs)
                        await $_getPrefetchedData<Task, $TasksTable, Step>(
                          currentTable: table,
                          referencedTable: $$TasksTableReferences
                              ._stepsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$TasksTableReferences(db, table, p0).stepsRefs,
...
final class $$StepsTableReferences
  ...
  static $TasksTable _taskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('steps__task_id__tasks__id');
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$StepsTable, Step>(table),
                  ...
                  >(state) {
                    if (taskId) {
                      state = state.withJoin(
                        ...
                        referencedTable: $$StepsTableReferences._taskIdTable(
                          db,
                        ),
...
typedef $$StepsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool taskId})
    >;
typedef $$ReminderJobsTableCreateCompanionBuilder =
    ReminderJobsCompanion Function({
      Value<int> notificationId,
      required String taskId,
      Value<int> revision,
      Value<bool> pending,
    });
typedef $$ReminderJobsTableUpdateCompanionBuilder =
    ReminderJobsCompanion Function({
      Value<int> notificationId,
      Value<String> taskId,
      Value<int> revision,
...
final class $$ReminderJobsTableReferences
    extends BaseReferences<_$AppDatabase, $ReminderJobsTable, ReminderJob> {
  $$ReminderJobsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $TasksTable _taskIdTable(_$AppDatabase db) =>
      db.tasks.createAlias('reminder_jobs__task_id__tasks__id');
...
class $$ReminderJobsTableFilterComposer
    extends Composer<_$AppDatabase, $ReminderJobsTable> {
  $$ReminderJobsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ReminderJobsTableOrderingComposer
    extends Composer<_$AppDatabase, $ReminderJobsTable> {
  $$ReminderJobsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ReminderJobsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ReminderJobsTable> {
  $$ReminderJobsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ReminderJobsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ReminderJobsTable,
          ...
          $$ReminderJobsTableOrderingComposer,
          $$ReminderJobsTableAnnotationComposer,
          $$ReminderJobsTableCreateCompanionBuilder,
          $$ReminderJobsTableUpdateCompanionBuilder,
          (ReminderJob, $$ReminderJobsTableReferences),
          ReminderJob,
          PrefetchHooks Function({bool taskId})
        > {
  $$ReminderJobsTableTableManager(_$AppDatabase db, $ReminderJobsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ReminderJobsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ReminderJobsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ReminderJobsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$ReminderJobsTable, ReminderJob>(table),
                  $$ReminderJobsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({taskId = false}) {
                  ...
                  >(state) {
                    if (taskId) {
                      state = state.withJoin(
                        currentTable: table,
                        currentColumn: table.taskId,
                        referencedTable: $$ReminderJobsTableReferences
                            ._taskIdTable(db),
                        referencedColumn: $$ReminderJobsTableReferences
                            ._taskIdTable(db)
                            .id,
                      ) as T;
                    }
...
typedef $$ReminderJobsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ReminderJobsTable,
      ReminderJob,
